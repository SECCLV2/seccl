    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <a href="verproyectos_c_historico.php">Proyectos año 2014</a> || 
                <a href="verproyectos_c.php">Proyectos año 2015</a>
                <center>
                    <br>
                    <center><?php echo '<font><strong>Proyectos Generados 2014</strong></font>'; ?></center>
                    </br>
                    <form>
                        <br>
                        ...
                        <center>
                            <table id="demotable1" >
                                ...
                                <?php
                                $fecha = '2014';
                                $query = "SELECT ID_PROYECTO,FECHA_ELABORACION,NIT_EMPRESA,ID_PLAN FROM PROYECTO where ID_CENTRO='$cen[0]' AND SUBSTR(FECHA_ELABORACION, 7,4) = 2014";
