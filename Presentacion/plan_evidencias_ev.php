                    ...
                    <form>
                        ...
                        <center>
                            <table id="demotable1" >
                                ...
                                $q2 = "select unique EP.id_proyecto from evaluador_proyecto EP INNER JOIN PROYECTO P ON EP.ID_PROYECTO = P.ID_PROYECTO where EP.id_evaluador=$doceva[0] AND SUBSTR(P.FECHA_ELABORACION,7,4) = 2015";
