    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <a href="verproyectos_c_b_historico.php">Proyectos año 2014</a> || 
                <a href="verproyectos_c_b.php">Proyectos año 2015</a>
                ...
                <center>
                    ...
                    <br>
                    <strong> PROYECTOS AÑO 2014 </strong>
                </center>
                <div id="resultado">
                    <?php
                    if ($r <> NULL || $r <> 0) {
                            ...
                            <form>
                                ...
                                <center>
                                    <table id="demotable1" >
                                        ...
                                        <?php
                                        $fecha = 2014;
                                        $query = "SELECT ID_PROYECTO,ID_REGIONAL,ID_CENTRO,FECHA_ELABORACION,NIT_EMPRESA,ID_PLAN,APROBADO_INSTRUMENTOS FROM PROYECTO WHERE ID_REGIONAL='$r' AND SUBSTR(FECHA_ELABORACION, 7,4) = 2014";
