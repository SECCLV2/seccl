    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                <center>
                    <a href="verproyectos_c_a_historico.php">Proyectos año 2014</a> || 
                    <a href="verproyectos_c_a.php">Proyectos año 2015</a>
                    <br><br>
                    <center><?php echo '<font><strong>Proyectos Generados año 2014</strong></font>'; ?></center>
                    <form>
                        <br>
                        ...
                        <center>
                            <table id="demotable1" >
                                ...
                                <?php
                                $fecha = date('Y');
                                $query = "SELECT ID_PROYECTO,FECHA_ELABORACION,NIT_EMPRESA,ID_PLAN FROM PROYECTO where (ID_CENTRO='$cen[0]' OR USU_REGISTRO='$id') AND SUBSTR(FECHA_ELABORACION, 7,4) = 2014";
