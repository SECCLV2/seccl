    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                ...
                $query = "SELECT ID_PLAN,FECHA_ELABORACION,ID_PLAN AS PRUEBA FROM PLAN_ANUAL WHERE ID_CENTRO='$cen[0]' AND SUBSTR(FECHA_ELABORACION, 7,4) = 2015";
                $statement = oci_parse($connection, $query);

                $queryPlan = ("SELECT COUNT(*) AS TOTAL FROM PLAN_ANUAL WHERE ID_CENTRO='$cen[0]' AND SUBSTR(FECHA_ELABORACION, 7,4) = 2015");
