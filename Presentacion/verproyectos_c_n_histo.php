    ...
    <body onload="inicio()">
        ...
        <div id="cuerpo">
            <div id="contenedorcito">
                <a href="verproyectos_c_n_histo.php">Proyectos año 2014</a> || 
                <a href="verproyectos_c_n.php">Proyectos año 2015</a>
                <?php
                ...
                <center>
                    ...
                    <form>
                        <br>
                        <center><?php echo '<font><strong> Proyectos 2014</strong></font>'; ?></center>
                        <br>
                        ...
                        <center>
                            <table id="demotable1" >
                                ...
                                <?php
                                $fecha = '2014';
                                $query = "SELECT ID_PROYECTO,ID_REGIONAL,ID_CENTRO,FECHA_ELABORACION,NIT_EMPRESA,ID_PLAN,APROBADO_INSTRUMENTOS FROM PROYECTO WHERE SUBSTR(FECHA_ELABORACION, 7,4) = 2014";
